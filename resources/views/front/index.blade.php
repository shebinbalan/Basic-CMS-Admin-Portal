        ...
        <section id="hero" class="s-hero">
            ...
            <div class="s-hero__slider">
                @foreach ($featured as $post)
                    ...
                    <div class="s-hero__slide-bg" style="background-image: url('assets/uploads/featured_image/{{ $post->featured_image }}'); width: 100%; height: 900px;"></div>
                        ...
                        @foreach ($posts as $post)
                            <article class="brick entry" data-aos="fade-up">
                                ...
                                <div class="entry__thumb">
                                    ...
                                    <img src="{{ asset('assets/uploads/featured_image/'.$post->featured_image) }}" class="featured_image" alt="Image here" style="width: 300px; height: auto;">
                                    </a>
                                ...
                                <div class="entry__text">
                                    <div class="entry__header">
                                        ...
                                        <div class="entry__meta">
                                            ...
                                            <span class="cat-links">
                                                <a href="#">{{ optional($post->category)->title }}</a>
                                            </span>
                                        </div>
                                    </div>
